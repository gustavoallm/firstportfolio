...
import portnew from "../../assets/portnew.png";
    ...
    return (
        <div className="container projects">
            ...
            <div className="box2 center">
                ...
                <br />
                <p>
                    PrimeFlix is a website that lists movies that have been released recently, also
                    gives you access to their details, a favorite page and a few more functions.
                </p>
                <br />
                ...
                <div className="access">
                    ...
                    <a
                        href="https://github.com/gustavoallm/primeflix"
                        target="_blank"
                        rel="noreferrer"
                    >
            ...
            <div className="box3 center">
                ...
                <br />
                <p>
                    The table is filled with data from the database created in MySQL and it is
                    possible to change the data through the modal that will open by clicking on the
                    desired field.
                </p>
                <br />
            ...
            <div className="box4 center">
                ...
                <p>
                    ...
                    information and delete the registration, all synchronized with the SSMS
                    database.
                </p>
                <br />
            ...
            <div className="box5 center">
                ...
                <br />
                <p>
                    This app is a validation form made with regex rules in JS utilizing bootstrap
                    for styling, was developed to reinforce my studies.
                </p>
                <br />
            ...
            <div className="box6 center">
                <h2 className="subtitle mtop-title">Actual portfolio</h2>
                <br />
                <p>
                    The page was developed by me, to test my knowledge right when I started studying
                    to be a front end dev.
                </p>
                <br />
                <img className="thumb" src={portnew} alt="First Portfolio" />
                <div className="access">
                    <a href="https://frontendgus.com.br/" target="_blank" rel="noreferrer">
                        <button className="projects-btn">Access portfolio</button>
                    </a>
                    <a
                        href="https://github.com/gustavoallm/reactport"
                        target="_blank"
                        rel="noreferrer"
                    >
                        <button className="projects-btn">Repository on GitHub</button>
